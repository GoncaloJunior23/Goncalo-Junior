...
export default function Renovar() {
  ...
  async function verificaRenovacao(data: Inputs) {
    ...
    console.log("Dados para envio:", { ...data, datadaEntrega: datadaRenovacaoFormatada }); // Log dos dados enviados
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        alert("Erro... DatadaEntrega, ClienteId ou LivroId incorretos");
      }
    } catch (error) {
        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
          <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form className="max-w-sm mx-auto" onSubmit={handleSubmit(verificaRenovacao)}>
                <div className="mb-5">
                  <input
                    type="text"
                    id="livroId"
